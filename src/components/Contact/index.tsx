...
const Contact = () => {
  return (
    <div className="w-screen min-h-[50%] flex flex-col items-center justify-center contact-bg mb-12 max-w-screen-md ">
      <div className="bg-bg-light border border-gray-500 shadow-2xl shadow-gray-600 rounded-tl-xl rounded-br-xl md:rounded-br-3xl md:rounded-tl-3xl w-[90%] min-h-[200px] p-3 sm:p-10">
