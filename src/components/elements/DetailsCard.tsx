  ...
  return (
    <div className="w-11/12 h-[175px] bg-text py-3 border-[1px] border-secondary-100 rounded-md shadow ">
      <div className="flex flex-row justify-start items-center">
        ...
        <h5 className="text-dark font-bold tracking-wide"> Connected address </h5>
      </div>

      <div className="flex flex-row pl-9">
        <span className="text-light text-md mt-[4px]">{useFormatAddress(props.address)}</span>
      </div>

      <div className="flex flex-row items-center mt-5">
        <RiExchangeDollarLine className="mx-2" />
        <h5 className="text-dark font-bold tracking-wide ml-1"> Token </h5>
