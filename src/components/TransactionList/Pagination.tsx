    ...
    <div className="w-full flex flex-row gap-2 my-2 ">
      <div className="flex flex-row gap-2 items-center ml-auto">
        ...
        <div className="flex flex-row gap-2 items-center">
          <button className="outline-none text-sm text-secondary-800 w-6 h-6 rounded-full p-2 border border-secondary-900 flex justify-center items-center">
            1
          </button>
          <button className="outline-none text-sm text-secondary-800 w-6 h-6 rounded-full p-2 border border-secondary-900 flex justify-center items-center">
            2
          ...
          <BiDotsHorizontal className="text-2xl text-secondary-900" />
